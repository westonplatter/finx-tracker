...
class Trade(models.Model):
    ...
    acct_alias = models.TextField(blank=True, null=True)
    ...
    orig_trade_date = models.TextField(blank=True, null=True)
    orig_trade_id = models.BigIntegerField(blank=True, null=True)
    orig_order_id = models.BigIntegerField(blank=True, null=True)
    clearing_firm_id = models.TextField(blank=True, null=True)
    ...
    order_reference = models.TextField(blank=True, null=True)
    volatility_order_link = models.TextField(blank=True, null=True)
    exch_order_id = models.TextField(blank=True, null=True)
    ...
    when_realized = models.TextField(blank=True, null=True)
    when_reopened = models.TextField(blank=True, null=True)
